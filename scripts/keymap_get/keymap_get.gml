function keymap_get(){
	return {
		player: {
			up:			(keyboard_check(vk_up) || gamepad_button_check(Gamepad.ID, gp_padu) || gamepad_axis_value(Gamepad.ID, gp_axislv) < 0),
			...
			interact: (keyboard_check_pressed(vk_up) || gamepad_button_check_pressed(Gamepad.ID, gp_padu)),
